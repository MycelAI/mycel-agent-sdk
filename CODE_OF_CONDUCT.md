...
- Email **[info@mycel-ai.de](mailto:info@mycel-ai.de)** (include a summary of
  what happened and, if applicable, links to public posts or PRs).
- For sensitive matters, use the same address; do not post private details on
...
For this project, **Community Moderators** are the maintainers of the
**MycelAI** organization, acting through the contact above.
...
1. **Event:** A pattern of repeated code of conduct violations that other
   ...
   the Community Moderators determine there is no way to keep the community safe
