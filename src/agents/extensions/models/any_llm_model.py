...
try:
    ...
    raise ImportError(
        ...
        "dependency group: `pip install 'mycel-agent-sdk[any-llm]'`. "
...
class AnyLLMModel(Model):
    ...
    def _fix_tool_message_ordering(
        ...
        from ...models.chatcmpl_tool_message_order import fix_tool_message_ordering

        return fix_tool_message_ordering(messages)
