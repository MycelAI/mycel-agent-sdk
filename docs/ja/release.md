...
search:
  exclude: true
---
# リリースプロセス / 変更履歴 {#release-processchangelog}
...
## 破壊的変更の変更履歴 {#breaking-change-changelog}
...
-   Chat Completions 統合は `should_replay_reasoning_content` による reasoning-content の再生を選択できるようになり、サードパーティ Chat Completions アダプター（例: DeepSeek）での reasoning / tool-call 継続性が向上しました。
...
このマイナーリリースでは **破壊的変更** は導入されません。主要な機能追加については上流 [OpenAI Agents SDK v0.12.0 リリースノート](https://github.com/openai/openai-agents-python/releases/tag/v0.12.0)（このフォークが追従する系譜）を確認してください。

### 0.11.0 {#0110}

このマイナーリリースでは **破壊的変更** は導入されません。主要な機能追加については上流 [OpenAI Agents SDK v0.11.0 リリースノート](https://github.com/openai/openai-agents-python/releases/tag/v0.11.0)（このフォークが追従する系譜）を確認してください。
