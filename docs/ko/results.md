...
## 올바른 결과 표면 선택 {#choose-the-right-result-surface}
...
## 입력, 다음 턴 기록, 새 아이템 {#input-next-turn-history-and-new-items}
...
### 서버 관리 연속 실행 {#server-managed-continuation}
...
## Agent-as-tool 메타데이터 {#agent-as-tool-metadata}
