...
[repo](https://github.com/MycelAI/mycel-agent-sdk/tree/main/examples)의 examples 섹션에서 SDK의 다양한 샘플 구현을 확인해 보세요. examples는 서로 다른 패턴과 기능을 보여주는 여러 카테고리로 구성되어 있습니다.
...
-   **[basic](https://github.com/MycelAI/mycel-agent-sdk/tree/main/examples/basic):**
    ...
    -   OpenAI Chat Completions를 통한 Runner 관리 재시도 (`examples/basic/retry_openai_chatcompletions.py`)
    -   비엄격 출력 타입
    -   이전 응답 ID 사용
