...
## 结果接口选择 {#choose-the-right-result-surface}
...
## 输入、下一轮历史与新项 {#input-next-turn-history-and-new-items}
...
## 会话续接或恢复 {#continue-or-resume-the-conversation}
...
### 服务端托管续接 {#server-managed-continuation}
...
## Agent-as-tool 元数据 {#agent-as-tool-metadata}
